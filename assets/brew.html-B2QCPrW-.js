import{_ as e,c as n,o as i,b as s}from"./app-Bxaimr4q.js";const l={},a=s(`<h4 id="brew" tabindex="-1"><a class="header-anchor" href="#brew"><span>brew</span></a></h4><p>—— Mac &quot;上的应用商店&quot;，包管理器； 安装、管理包很方便</p><p>官网：<a href="https://brew.sh" target="_blank" rel="noopener noreferrer">https://brew.sh</a></p><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h3><p>1、官方安装     <div size="2" color="#CCCCCC">(命令可能执行会很慢，建议开起命令行代理)</div></p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>/bin/bash -c &quot;$(curl -fsSL https://raw.githubusercontent.com/Homebrew/install/HEAD/install.sh)&quot;
